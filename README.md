# Active-Directory-Automatically-Detecting-Domain-User-Status-Login-Times-via-Powershell
 
------

# Note: Copy this file and save it as: "AD_User_Audit_Command.bat" file in Desktop -> Run it as administrator
